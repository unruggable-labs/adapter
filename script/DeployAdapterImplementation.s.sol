...
contract DeployAdapterImplementationScript is Script {
    ...
    string internal constant SIG_ATTESTED = "Attested(address,bytes32,bytes32,bytes32,bytes32,bytes)";
